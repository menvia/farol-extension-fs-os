...
- To install, run:
  `npm install farol-extension-fs-os`

- To update, run:
  `npm update farol-extension-fs-os`
...
On the project used to develop the library you can run `npm link farol-extension-fs-os` and it will start using the development version from your API.
